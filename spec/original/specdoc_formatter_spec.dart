  ...
  spec() {
    ...
    describe("SpecDocFormatter", {
      ...
      "prints out the details of any failed tests": (){
        ...
        Expect.isTrue(output.contains("Function: 'SpecDocFormatterSpec_Test.function'", 0));
        Expect.isTrue(output.contains("spec/original/specdoc_formatter_spec.dart'", 0));
      },
      ...
      "prints out the details of any pending tests": (){
        Expect.isTrue(output.contains("\nPending:\n\n  SpecDocFormatterSpec_Test bar bar-2", 0));
      },
